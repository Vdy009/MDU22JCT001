...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8" style="background-color:#f8f9fa;">
			<div class="m-3">
				<form name="form1" method="post" action="facultyregprocess">
				<div class="row">
				...
				<div class="row">
					<div class="col-md-4">
							...
							<input style="background-color:#DAF7A6" type="text" class="form-control" id="fid" name="fid" required>
					</div>
					<div class="col-md-4">
					...
					<div class="col-md-4">
							...
							<input style="background-color:#DAF7A6" type="text" class="form-control" id="email" name="email" required>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
