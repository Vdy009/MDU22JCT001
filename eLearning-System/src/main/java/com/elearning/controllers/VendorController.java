...
public class VendorController {
	...
	public String updatecourse(Course c,RedirectAttributes redirAttrs) {		
		csrv.updateCourse(c);
	...
	public String updateservice(Service s,RedirectAttributes redirAttrs) {		
		ssrv.updateservice(s);
	...
	public String allorders(Model model) {
		String vendorid=session.getAttribute("userid").toString();
		List<Orders> courses=osrv.vendorOrders(vendorid, "Course");
		System.out.println(courses);
		model.addAttribute("clist",courses );
		model.addAttribute("slist", osrv.vendorOrders(vendorid, "Service"));
		return "orders";
	}
}
