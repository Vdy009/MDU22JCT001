...
<div class="card shadow" style="background-image: ">
	...
	<div class="card-img-overlay">
		<div class="card-body">
			...
			<h4 class="p-2" style="border-bottom: 2px solid green;">Users
				List</h4>
				...
				<tbody>
					<c:forEach var="u" items="${users }">
						<tr>
							...
							<td><a href="/edituser?id=${u.userid }"
