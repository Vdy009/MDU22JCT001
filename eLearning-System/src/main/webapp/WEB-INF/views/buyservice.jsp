					...
					<div class="card shadow"">
						...
						<div class="card-body">
							<div class="form-group form-row">
								...
								<div class="col-sm-8" style="font-weight: bold; color:Blue;">${c.sname }</div>
							</div>
							<div class="form-group form-row">
								<label class="col-sm-4">Price</label>
								<div class="col-sm-8" style="font-weight: bold; color:Blue;">&#8377; ${c.price }</div>
							</div>
							...
							<div class="card-body">
								...
								<form method="post">
									...
									<input type="hidden" name="userid"
										...
										type="hidden" name="itemname" value="${c.sname }"> <input
										type="hidden" name="itemtype" value="Service">
									<div class="form-group form-row">
										<label class="col-sm-4 col-form-label">Amount</label>
										<div class="col-sm-8">
											<input type="text" readonly name="price" value="${c.price }"
												class="form-control" />
										</div>
									</div>
									<div class="form-group form-row">
